...
const SKINS: Skin[] = [
  ...
  // ── 50 additional skins ───────────────────────────────────────────────
  { id: "ember",     name: "Ember Trail",    palette: ["#ff6a00", "#c1121f"], cost: 40,  tier: "common" },
  { id: "mint",      name: "Mint Circuit",   palette: ["#8effc1", "#00b894"], cost: 40,  tier: "common" },
  { id: "slate",     name: "Slate Runner",   palette: ["#b0bec5", "#455a64"], cost: 40,  tier: "common" },
  { id: "blush",     name: "Blush Wave",     palette: ["#ffc2d1", "#ff5d8f"], cost: 45,  tier: "common" },
  { id: "sand",      name: "Desert Sand",    palette: ["#ffe0a3", "#c9925e"], cost: 45,  tier: "common" },
  { id: "sea",       name: "Sea Glass",      palette: ["#9fe7e0", "#2a9d8f"], cost: 45,  tier: "common" },
  { id: "grape",     name: "Grape Soda",     palette: ["#c084fc", "#7c3aed"], cost: 50,  tier: "common" },
  { id: "clay",      name: "Clay Bronze",    palette: ["#e0a071", "#8c4a2f"], cost: 50,  tier: "common" },
  { id: "olive",     name: "Olive Drift",    palette: ["#d5e04a", "#6b7f1a"], cost: 50,  tier: "common" },
  { id: "steel",     name: "Steel Pulse",    palette: ["#cfd8ff", "#3f51b5"], cost: 55,  tier: "common" },

  { id: "toxic",     name: "Toxic Bloom",    palette: ["#ccff00", "#009e60"], cost: 90,  tier: "rare" },
  { id: "cherry",    name: "Cherry Static",  palette: ["#ff4d6d", "#8b0034"], cost: 90,  tier: "rare" },
  { id: "azure",     name: "Azure Streak",   palette: ["#5ad1ff", "#0047ab"], cost: 95,  tier: "rare" },
  { id: "amethyst",  name: "Amethyst Hum",   palette: ["#d9a5ff", "#5b21b6"], cost: 95,  tier: "rare" },
  { id: "tangerine", name: "Tangerine Rush", palette: ["#ffb03a", "#e63900"], cost: 100, tier: "rare" },
  { id: "jade",      name: "Jade Serpent",   palette: ["#57ffb0", "#00644a"], cost: 100, tier: "rare" },
  { id: "cobalt",    name: "Cobalt Arc",     palette: ["#6f8bff", "#1a1aad"], cost: 105, tier: "rare" },
  { id: "rose",      name: "Rose Circuit",   palette: ["#ff8fb1", "#c9184a"], cost: 105, tier: "rare" },
  { id: "flare",     name: "Solar Flare",    palette: ["#fff176", "#ff6f00"], cost: 110, tier: "rare" },
  { id: "abyss",     name: "Abyss Blue",     palette: ["#3a7bd5", "#00111f"], cost: 110, tier: "rare" },
  { id: "orchid",    name: "Orchid Glow",    palette: ["#ff7ff0", "#8e00b3"], cost: 115, tier: "rare" },
  { id: "moss",      name: "Moss Reactor",   palette: ["#a8e063", "#1f4d1f"], cost: 115, tier: "rare" },
  { id: "copper",    name: "Copper Coil",    palette: ["#ffb07c", "#a0522d"], cost: 120, tier: "rare" },
  { id: "aqua",      name: "Aqua Vapor",     palette: ["#7ffff0", "#008b8b"], cost: 120, tier: "rare" },
  { id: "plum",      name: "Plum Static",    palette: ["#e39ff6", "#4a0e4e"], cost: 125, tier: "rare" },
  { id: "signal",    name: "Signal Red",     palette: ["#ff5a5a", "#7a0000"], cost: 125, tier: "rare" },
  { id: "lagoon",    name: "Neon Lagoon",    palette: ["#00ffc8", "#0066aa"], cost: 130, tier: "rare" },
  { id: "dusk",      name: "Dusk Gradient",  palette: ["#ff9a8b", "#4a00e0"], cost: 130, tier: "rare" },
  { id: "chrome",    name: "Chrome Edge",    palette: ["#f2f6ff", "#7a8ca3"], cost: 135, tier: "rare" },
  { id: "ultra",     name: "Ultraviolet",    palette: ["#c77dff", "#2d00f7"], cost: 140, tier: "rare" },
  { id: "sonar",     name: "Sonar Green",    palette: ["#3dff9e", "#00593f"], cost: 140, tier: "rare" },
  { id: "carbon",    name: "Carbon Neon",    palette: ["#6ee7ff", "#101018"], cost: 145, tier: "rare" },
  { id: "peach",     name: "Peach Drive",    palette: ["#ffd0a1", "#ff5e5b"], cost: 145, tier: "rare" },
  { id: "indigo",    name: "Indigo Storm",   palette: ["#8ea2ff", "#1a237e"], cost: 150, tier: "rare" },
  { id: "acidpink",  name: "Acid Pink",      palette: ["#ff4fd8", "#a3006e"], cost: 150, tier: "rare" },

  { id: "obsidian",  name: "Obsidian Core",  palette: ["#8b95ff", "#05050a"], cost: 260, tier: "legendary" },
  { id: "phoenix",   name: "Phoenix Rise",   palette: ["#ffe066", "#ff1e00"], cost: 275, tier: "legendary" },
  { id: "nebula",    name: "Nebula Drift",   palette: ["#ff6ec7", "#3a0ca3"], cost: 290, tier: "legendary" },
  { id: "titan",     name: "Titan Alloy",    palette: ["#e6ecf5", "#2f3b52"], cost: 300, tier: "legendary" },
  { id: "venom",     name: "Venom Strike",   palette: ["#b6ff00", "#3d0066"], cost: 315, tier: "legendary" },
  { id: "quantum",   name: "Quantum Flux",   palette: ["#00ffe0", "#7000ff"], cost: 330, tier: "legendary" },
  { id: "supernova", name: "Supernova",      palette: ["#fff9c4", "#ff3d00"], cost: 345, tier: "legendary" },
  { id: "eclipse",   name: "Eclipse Ring",   palette: ["#ffcf40", "#12002e"], cost: 360, tier: "legendary" },
  { id: "seraph",    name: "Seraph White",   palette: ["#ffffff", "#8fd3ff"], cost: 375, tier: "legendary" },
  { id: "hologram",  name: "Hologram",       palette: ["#a0ffef", "#ff9ef7"], cost: 400, tier: "legendary" },
  { id: "vaporwave", name: "Vaporwave",      palette: ["#ff71ce", "#01cdfe"], cost: 420, tier: "legendary" },
  { id: "cosmos",    name: "Cosmic Tide",    palette: ["#5ce1e6", "#2b0a5e"], cost: 440, tier: "legendary" },
  { id: "molten",    name: "Molten Vein",    palette: ["#ffbf00", "#8b0000"], cost: 460, tier: "legendary" },
  { id: "spectral",  name: "Spectral Veil",  palette: ["#d0f5ff", "#6a00ff"], cost: 480, tier: "legendary" },
  { id: "royal",     name: "Royal Circuit",  palette: ["#ffd966", "#1b1464"], cost: 520, tier: "legendary" },
  { id: "singular",  name: "Singularity",    palette: ["#00fff7", "#000000"], cost: 600, tier: "legendary" },
  { id: "apex4d",    name: "Apex 4D",        palette: ["#ff00aa", "#00ff9f"], cost: 750, tier: "legendary" },
];
...
function NeonSlither() {
  ...
  useEffect(() => {
    ...
    // Boost is only controlled by the dedicated on-screen button; canvas taps just steer.

    // Touch state: first finger = coarse steer, second finger = precision joystick.
    ...
    const ts = (e: TouchEvent) => {
      ...
      for (let i = 0; i < e.changedTouches.length; i++) {
        ...
        if (primaryId === null) {
          ...
          // First touch: steer toward touch point (no boost)
    ...
    const tm = (e: TouchEvent) => {
      ...
      for (let i = 0; i < e.touches.length; i++) {
        const t = e.touches[i];
        if (t.identifier === precisionId && precisionAnchor) {
